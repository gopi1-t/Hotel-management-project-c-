...
int main()
{
    ...
    cin>>qnt;
        if (qchkburger - qchkburger >= qnt)
        {
            ...
            Total_burger = Total_burger + qnt;
            cout << "\n\n\t\t" << qnt << "chicken burger ordered "<< "price has to be paid is  " << qnt * 140;
        }
        else
    ...
    cin>>qnt;
        ...
        case 8:
        cout<<"the total rooms sales is " <<srms;
        cout<<"the toal salles of pasta is " <<spasta;
        cout<<"the toal salles of burger is " <<sburger;
        cout<<"the toal salles of chiken burger is "<<schkburger;
        cout<<"the toal salles of shake is " <<sshake;
        cout<<"the toal salles of mutton is " <<smutton;
        cout<<"the toal salles of chowmin is " <<schowmin;
